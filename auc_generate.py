...
for file_num, filename in enumerate(onlyfiles):
    ...
    output_mappings = [[1000, 0], [200, 0], [100, 0], [10, 0], [1, 0]]
    for index in range(0, len(AUC_MAPPINGS_TN[0:-1])):
        ...
        for output_mapping in output_mappings:
            ...
            if index % divider == 0:
                ...
                ftnc = AUC_MAPPINGS_TN[index + divider]
                ffpc = AUC_MAPPINGS_FP[index + divider]
...
output_file_name = "auc_output.csv"  # file name
f = open(output_file_name, "w")
header = f"Filename;AUC10;AUC50;AUC100;AUC1000;AUC10000;"
writer = csv.writer(f)
